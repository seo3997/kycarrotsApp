    ...
    private fun fetchBranchList() {
        ...
        lifecycleScope.launch {
            try {
                ...
                val adapter = ArrayAdapter(this@OnboardingActivity, android.R.layout.simple_dropdown_item_1line, branchNames)
                ...
                Log.e("OnboardingActivity", "지점 목록 조회 오류", e)
            }
        }
    }
